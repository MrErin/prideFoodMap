...
The Pride Food Map is an interactive map showing food resources (community fridges and donation sites) in Chattanooga, TN. v1 has shipped with type-safe testing, card list UI with bi-directional sync, search/filter capabilities, and accessibility polish.

## Milestones

- ✅ **v1** — Phases 1-4 (shipped 2026-02-03)
- 📋 **v2** — Not started (planning phase)

## Phases

<details>
<summary>✅ v1 (Phases 1-4) — SHIPPED 2026-02-03</summary>
...
No phases planned yet. Run `/gsd:new-milestone` to define v2 goals and requirements.
